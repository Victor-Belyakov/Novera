...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/User/Infrastructure/Persistence'), (\dirname(__DIR__, 4).'/src/Auth/Infrastructure/Persistence')]));

        $a->addDriver($b, 'App\\User\\Infrastructure\\Persistence');
        $a->addDriver($b, 'App\\Auth\\Infrastructure\\Persistence');

        $instance->setEntityNamespaces(['User' => 'App\\User\\Infrastructure\\Persistence', 'Auth' => 'App\\Auth\\Infrastructure\\Persistence']);
