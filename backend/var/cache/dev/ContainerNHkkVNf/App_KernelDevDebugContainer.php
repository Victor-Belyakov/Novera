...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Auth\\Controller\\LogoutController' => 'getLogoutControllerService',
            'App\\Auth\\Controller\\RefreshTokenController' => 'getRefreshTokenControllerService',
            'App\\Auth\\Controller\\RegisterController' => 'getRegisterControllerService',
            'App\\Category\\Controller\\CategoryController' => 'getCategoryControllerService',
            'App\\FinanceCategory\\Controller\\FinanceCategoryController' => 'getFinanceCategoryControllerService',
            'App\\FinancePlan\\Controller\\FinancePlanController' => 'getFinancePlanControllerService',
            'App\\Finance\\Controller\\FinanceController' => 'getFinanceControllerService',
            'App\\Goal\\Controller\\GoalController' => 'getGoalControllerService',
            'App\\Habit\\Controller\\HabitController' => 'getHabitControllerService',
            'App\\HealthMetricEntry\\Controller\\HealthMetricEntryController' => 'getHealthMetricEntryControllerService',
            'App\\HealthMetricType\\Controller\\HealthMetricTypeController' => 'getHealthMetricTypeControllerService',
            'App\\PersonalState\\Controller\\PersonalStateController' => 'getPersonalStateControllerService',
            'App\\Reminder\\Controller\\ReminderController' => 'getReminderControllerService',
            'App\\Statistic\\Controller\\StatisticController' => 'getStatisticControllerService',
            'App\\Task\\Controller\\TaskController' => 'getTaskControllerService',
            'App\\Telegram\\Controller\\TelegramController' => 'getTelegramControllerService',
            'App\\User\\Controller\\UserController' => 'getUserControllerService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [#[\Closure(name: 'App\\Auth\\Infrastructure\\EventListener\\JWTCreatedListener')] fn () => ($container->privates['App\\Auth\\Infrastructure\\EventListener\\JWTCreatedListener'] ??= new \App\Auth\Infrastructure\EventListener\JWTCreatedListener()), 'onJWTCreated'], 0);
        $instance->addListener('lexik_jwt_authentication.on_authentication_success', [#[\Closure(name: 'App\\Auth\\Infrastructure\\EventListener\\LoginSuccessListener')] fn () => ($container->privates['App\\Auth\\Infrastructure\\EventListener\\LoginSuccessListener'] ?? $container->load('getLoginSuccessListenerService')), 'onAuthenticationSuccess'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Auth\\Controller\\LogoutController', 'App\\Auth\\Controller\\RefreshTokenController', 'App\\Auth\\Controller\\RegisterController', 'App\\Category\\Controller\\CategoryController', 'App\\Finance\\Controller\\FinanceController', 'App\\FinanceCategory\\Controller\\FinanceCategoryController', 'App\\FinancePlan\\Controller\\FinancePlanController', 'App\\Goal\\Controller\\GoalController', 'App\\Habit\\Controller\\HabitController', 'App\\HealthMetricEntry\\Controller\\HealthMetricEntryController', 'App\\HealthMetricType\\Controller\\HealthMetricTypeController', 'App\\PersonalState\\Controller\\PersonalStateController', 'App\\Reminder\\Controller\\ReminderController', 'App\\Statistic\\Controller\\StatisticController', 'App\\Task\\Controller\\TaskController', 'App\\Telegram\\Controller\\TelegramController', 'App\\User\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private '.service_locator.tnAxedV' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_TnAxedVService($container)
    {
        $instance = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'security.firewall.map.context.telegram_webhook' => ['privates', 'security.firewall.map.context.telegram_webhook', 'getSecurity_Firewall_Map_Context_TelegramWebhookService', true],
            'security.firewall.map.context.telegram_auth' => ['privates', 'security.firewall.map.context.telegram_auth', 'getSecurity_Firewall_Map_Context_TelegramAuthService', true],
            'security.firewall.map.context.telegram_config' => ['privates', 'security.firewall.map.context.telegram_config', 'getSecurity_Firewall_Map_Context_TelegramConfigService', true],
            ...
            'security.firewall.map.context.telegram_webhook' => '?',
            'security.firewall.map.context.telegram_auth' => '?',
            'security.firewall.map.context.telegram_config' => '?',
        ...
        if (isset($container->privates['.service_locator.tnAxedV'])) {
            return $container->privates['.service_locator.tnAxedV'];
        }

        return $container->privates['.service_locator.tnAxedV'] = $instance;
    }
    ...
    {
        $a = ($container->privates['.service_locator.tnAxedV'] ?? self::get_ServiceLocator_TnAxedVService($container));
        ...
        $instance = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            yield 'security.firewall.map.context.telegram_webhook' => ($container->privates['.security.request_matcher.5fC9tOj'] ?? $container->load('get_Security_RequestMatcher_5fC9tOjService'));
            yield 'security.firewall.map.context.telegram_auth' => ($container->privates['.security.request_matcher.IGTaPK0'] ?? $container->load('get_Security_RequestMatcher_IGTaPK0Service'));
            yield 'security.firewall.map.context.telegram_config' => ($container->privates['.security.request_matcher.Ip0Td.Q'] ?? $container->load('get_Security_RequestMatcher_Ip0Td_QService'));
            ...
            yield 'security.firewall.map.context.register' => ($container->privates['.security.request_matcher.rweOSym'] ?? $container->load('get_Security_RequestMatcher_RweOSymService'));
            yield 'security.firewall.map.context.refresh' => ($container->privates['.security.request_matcher.lA7pkgD'] ?? $container->load('get_Security_RequestMatcher_LA7pkgDService'));
